...
export default function FriendsPickemPage() {
  return <div className="route-app group-friends"><RouteAppBootstrap slug="friends" /><PickemApp appSlug="friends" /><CompanionAppEnhancements slug="friends" /><CompanionFineTune slug="friends" /></div>;
}
