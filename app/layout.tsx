...
import CardOrderEnhancement from "@/components/CardOrderEnhancement";
...
import SideBetLedgerEnhancement from "@/components/SideBetLedgerEnhancement";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" data-theme="light">
      ...
      <body>{children}<AppExperienceEnhancements /><CardOrderEnhancement /><SideBetLedgerEnhancement /><ReceivedSideBetPresentation /><SideBetSelfLabels /><DogPickAdjustmentAlerts /><PlayerProfiles /><TestIncomingOfferPreview /></body>
    </html>
  );
}
