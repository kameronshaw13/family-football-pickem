...
import SideBetAutoSync from "@/components/SideBetAutoSync";
import SideBetDisplayGuard from "@/components/SideBetDisplayGuard";
import SideBetSurfaceWake from "@/components/SideBetSurfaceWake";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" data-theme="light">
      ...
      <body>{children}<AppExperienceEnhancements /><AppUiCoordinator /><DogPickAdjustmentAlerts /><PlayerProfiles /><SideBetSurfaceWake /><SideBetAutoSync /><SideBetDisplayGuard /></body>
    </html>
  );
}
