...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" data-theme="light" style={{ "--font-display": '"IBM Plex Sans Condensed", "Arial Narrow", Arial, sans-serif' } as React.CSSProperties}>
      <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Condensed:wght@400;500;600;700&display=swap" />
      </head>
