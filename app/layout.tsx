...
import SideBetPresentationFixes from "@/components/SideBetPresentationFixes";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" data-theme="light">
      ...
      <body>{children}<AppExperienceEnhancements /><AppUiCoordinator /><DogPickAdjustmentAlerts /><PlayerProfiles /><SideBetPresentationFixes /></body>
    </html>
  );
}