...
.manual-lock-review .manual-lock-pick-cell>.team-name,.manual-lock-review .manual-lock-pick-cell>.team-spread{line-height:1.3!important;overflow:visible}
...
.game-time,.game-final-status,.game-live-status,.game-live-situation{line-height:1.2!important;overflow:visible}
`;
