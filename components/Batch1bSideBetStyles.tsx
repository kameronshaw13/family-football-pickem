...
.card-panel .group-card>h3:has(+.group-empty-picks){border-bottom:0!important;box-shadow:inset 0 -1px 0 var(--line)!important}
...
.manual-pick-lock{height:30px!important;min-height:30px!important;min-width:62px!important;font-size:11px!important;font-weight:700!important;line-height:1.2!important}
...
.manual-lock-review .manual-lock-pick-cell>.team-name,.manual-lock-review .manual-lock-pick-cell>.team-spread{padding-block:1px;margin-block:-1px}
.manual-lock-review .confirmation-kickoff.manual-lock-meta{border-top:0!important;border-bottom:1px solid var(--line-strong)!important;color:var(--header-muted)!important;font-family:var(--font-display);font-size:10px!important;font-weight:700!important;letter-spacing:0}
.manual-lock-review .manual-lock-note{color:var(--ink)!important;font-weight:600!important}
.game-time,.game-final-status,.game-live-status,.game-live-situation{padding-block:1px;margin-block:-1px}
.responsive-text-value{padding-block:1px;margin-block:-1px}
.pick-title,.visible-pick-copy>strong,.side-bet-slip-title h2,.side-bet-slip-title p,.side-bet-offer-copy>strong,.side-bet-offer-copy p,.leaderboard-player strong,.bank-result-player,.bank-game-result>div strong,.side-bet-ledger-title,.rule-item summary strong,.scoreboard-heading h2,.standings-heading-row h2{padding-block:1px;margin-block:-1px}
`;
