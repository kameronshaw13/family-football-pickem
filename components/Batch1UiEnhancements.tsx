...
const BATCH1_STYLES = `
.rule-item:not([open]) summary{min-height:50px;padding-top:4px;padding-bottom:4px}
.rule-item[open] summary{min-height:55px}
.rule-item[open] .rule-copy{padding-top:3px}
...
.game-card.final-outcome .team-row.outcome-loss .team-name,.game-card.final-outcome .team-row.outcome-loss .team-board-market,.game-card.final-outcome .team-row.outcome-loss .team-result-score{color:color-mix(in srgb,var(--ink) 72%,var(--muted) 28%);-webkit-text-fill-color:color-mix(in srgb,var(--ink) 72%,var(--muted) 28%)}
.game-card.final-outcome .team-row.outcome-loss .team-logo,.score-bug-team.outcome-loss .team-logo{opacity:.82;filter:saturate(.85)}
.score-bug-team.outcome-loss .score-bug-score{color:color-mix(in srgb,var(--ink) 72%,var(--muted) 28%)}
